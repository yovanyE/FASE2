...
public class ClienteController {
    ...
    public String crearCuentaBancaria(int numeroCuenta, int idTipoCuenta, int idClienteindividual, int idClienteempresarial) {
        String respuesta = null;
        try {
    ...
    public CuentaBancaria modificarCuenta(int numeroCuenta, int idTipoCuenta, int numeroCui, int idClienteEmpresa) {
        ...
        try {
            ...
            procedimiento.setInt(3, idClienteEmpresa);
    ...
    public String IngresarPrestamos(double cantidadDinero, int numeroCui, int idmodalidad) {
        String respuesta = null;
        try {
