...
namespace ejemplobienHecho
{
    public partial class pageCuentaBancaria : System.Web.UI.Page
    {
        ...
        protected void btnRegistrar_Click(object sender, EventArgs e)
        {
            try
            {
                if (control.CuentaBancaria(int.Parse(txtNumeroCuenta.Text), int.Parse((ddlTipoC.SelectedValue.ToString())), int.Parse(txtCuicliente.Text), int.Parse(txtEmpresa.Text)) != null)
                {
        ...
        protected void btnModifica_Click(object sender, EventArgs e)
        {
            //try
            //{
            //    wsBanco.cuentaBancaria modificar = control.modificarCuentaBancaria(int.Parse(txtNumeroCuenta.Text), int.Parse(ddlTipoC.SelectedValue), int.Parse(txtCuicliente.Text), int.Parse(txtEmpresa.Text));
            //    if (control.modificarCuentaBancaria(int.Parse(txtNumeroCuenta.Text), int.Parse(ddlTipoC.SelectedValue), int.Parse(txtCuicliente.Text), int.Parse(txtEmpresa.Text)) != null)
            //    {
